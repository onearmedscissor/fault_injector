...
<body>
	<div class="ink-grid">
		...
		<header class="vertical-space">
			<h1>
				FAULT INJECTOR<small>Edit workload</small>
			</h1>
					...
					<fieldset>
						...
						<div class="control-group column-group gutters required">
							<label for="app1name" class="all-20 align-right">Application
								#1</label>
							<div class="control all-50">
								<s:textfield id="app1name" name="app1Name"
									value="%{workload.app_1_name}" />
							</div>
							<div class="all-30"></div>
						</div>
						...
						<div class="control-group column-group gutters">
							<label for="app2name" class="all-20 align-right">Application
								#2</label>
							<div class="control all-50">
								<s:textfield id="app2name" name="app2Name"
									value="%{workload.app_2_name}" />
							</div>
							<div class="all-30"></div>
						</div>
						<%-- 	                        </s:if> --%>
						...
						<div class="control-group column-group gutters">
							<label for="app3name" class="all-20 align-right">Application
								#3</label>
							<div class="control all-50">
								<s:textfield id="app3name" name="app3Name"
									value="%{workload.app_3_name}" />
							</div>
							<div class="all-30"></div>
						</div>
						<%-- 	                        </s:if> --%>
