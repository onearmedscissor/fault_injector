	...
	<div class="ink-grid">
            ...
            <div class="column-group">
				...
				<s:if test="experiments.size > 0">
					<table class="ink-table grey tableSection">
						<thead>
						...
						<s:iterator value="experiments">
							<tr id="row_<s:property value="i"/>">
								...
								<!-- <a href="<s:url action="sayhey"> <s:param name="user">${value}</s:param></s:url>"><c:out value="${value}" /></a> -->
								<td class="all-15"><a href="edit_experiment.jsp">edit</a></td>
                                <td class="all-5">|</td>
				...
				<!--<table class="ink-table grey tableSection">
                        ...
                        <tbody>
                            <tr>
                                <td class="all-100"><a href="#">Experiment_1</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
                            </tr>
                            <tr>
                                <td class="all-100"><a href="#">Experiment_2</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
                            ...
                            <tr>
                                <td class="all-100"><a href="#">Experiment_3</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
                            ...
                            <tr>
                                <td class="all-100"><a href="#">Experiment_4</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
                            ...
                            <tr>
                                <td class="all-100"><a href="#">Experiment_5</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
                            ...
                            <tr>
                                <td class="all-100"><a href="#">Experiment_6</a></td>
                                <td class="all-15"><a href="#">edit</a></td>
                                <td class="all-5">|</td>
                                <td class="all-15"><a href="#">delete</a></td>
                                <td class="all-5"><a href="#">?</a></td>
