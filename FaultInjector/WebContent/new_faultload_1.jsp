...
<body>
	<div class="ink-grid">
		...
		<div class="column-group">
			<div class="all-100">
				<form action="createfaultload1" id="page_1"
					...
					<fieldset>
						<div class="control-group column-group gutters required">
							...
							<div class="control all-50">
								<s:textfield id="name" name="name"
									value="%{#session.faultloadBean.name}" />
							</div>
						...
						<div class="control-group column-group gutters required">
							...
							<div class="control all-50">
								<s:textarea id="description" name="description"
									value="%{#session.faultloadBean.description}" rows="5"
									maxlength="300" />
							</div>
							<div class="all-30"></div>
						</div>
						...
						<div class="control-group column-group gutters required">
							<label for="timeinterval" class="all-20 align-right">Time
								interval (ms)</label>
							<div class="control all-50">
								<s:textfield id="timeinterval" name="timeInterval"
									value="%{#session.faultloadBean.timeInterval}" />
							</div>
							<div class="all-30"></div>
						</div>
