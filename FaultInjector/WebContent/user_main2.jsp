...
<body>
	<div class="ink-grid">
		...
		<header class="vertical-space">
			<h1>
				FAULT INJECTOR<small>User main menu</small>
			</h1>
		...
		<div class="column-group gutters">
			<div class="all-100">
				...
				<table id="experiments" class="ink-table dynamicTable">
					<thead>
						<tr>
							<th colspan="4" class="align-left large">Select the
								experiment to run:</th>
						</tr>
					</thead>
							...
							<s:iterator value="experiments">
								<tr class="all-100 column-group">
									<td class="all-70 quarter-top-space"><a
										href="<s:url action="showexperiment"><s:param name="id"><s:property value="exp_id"/></s:param></s:url>"
										class="large all-100"><s:property value="name" /></a></td>
									<td class="all-15"><a
										href="<s:url action="editexperiment"><s:param name="id"><s:property value="exp_id"/></s:param></s:url>"
										class="ink-button all-100">edit</a></td>
									<td class="all-15"><a
										href="<s:url action="deleteexperiment"><s:param name="id"><s:property value="exp_id"/></s:param></s:url>"
				...
				<div id="help-experiments" class="ink-alert block info" role="alert"
					...
					<p>Here you can view, edit, delete or run previously created
						experiments, or alternatively start creating a new one. To select
						an experiment, please click on the corresponding row on the table
						above.</p>
				</div>

				<form action="#">
					<button class="ink-button dynamicButton all-20" disabled>Run
						selected experiment</button>
				</form>
				<h4 class="top-space">New Experiment</h4>
				<hr />
				<a href="clearnewexperimentforward" class="ink-button all-20"
					id="create">Create new experiment...</a>
			</div>
		</div>
	</div>
