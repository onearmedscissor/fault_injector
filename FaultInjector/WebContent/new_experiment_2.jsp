	...
	<div class="ink-grid">
		...
		<div class="column-group gutters">
			<div class="all-100">
						...
						<s:if test="targets.size > 0">
							<s:iterator value="targets">
								...
								<td class="all-70 quarter-top-space"><a
									href="<s:url action="showtarget"><s:param name="id"><s:property value="target_id"/></s:param></s:url>"
									class="large all-100"><s:property value="name" /></a></td>
								<td class="all-15"><a
									href="<s:url action="edittarget"><s:param name="id"><s:property value="target_id"/></s:param></s:url>"
									class="ink-button all-100">edit</a></td>
								<td class="all-15"><a
									href="<s:url action="deletetarget"><s:param name="id"><s:property value="target_id"/></s:param></s:url>"
				...
				<div id="help-targets" class="ink-alert block info" role="alert"
					style="display: none">
					<button class="ink-dismiss">&times;</button>
					<h4>Target options menu</h4>
					<p>Here you can view, edit or delete previously created targets
						or alternatively create a new one.</p>
				</div>

				<a href="new_target.jsp" class="ink-button all-20" id="newtarget">Create
					new target...</a>
				<div class="column-group push-center">
					<a href="new_experiment_1.jsp"
						class="ink-button double-top-space all-25" id="previous">&lt;
						Previous</a>
					<button class="ink-button double-top-space all-25 dynamicButton"
