	...
	<div class="ink-grid">
		...
		<div class="column-group">
			...
			<div class="all-50">
				...
				<h3 class="quarter-bottom-space">1.2 Fault model: target
				...
				<table class="ink-table hover alternating checkbox">
					<thead>
						<tr>
							<th class="all-5"></th>
							<th class="all-95 align-left large">Select the registers to
								use:</th>
						</tr>
					</thead>
					<tbody class="all-100">
						<s:if test="registers.size > 0">
							<s:iterator value="registers">
								<tr class="all-100">
										...
										<div class="ink-form quarter-top-space">
											<div class="control-group" style="margin: 0">
												<ul class="control unstyled" style="margin: 0">
													<s:if
														test="#session.faultloadBean.containsRegisterId(reg_id) == true">
														<li style="margin: 0"><input type="checkbox"
															class="cb" name="select"
															id="<s:property value="reg_id"/>" value="" checked><label
															for=""></label></li>
													</s:if>
													<s:else>
														<li style="margin: 0"><input type="checkbox"
															class="cb" name="select"
															id="<s:property value="reg_id"/>" value=""><label
															for=""></label></li>
													</s:else>
												</ul>
											</div>
									...
									<td class="all-100"><a href="#" class="large align-left"><s:property
												value="name" /></a></td>
								</tr>
							</s:iterator>
						</s:if>
				...
				<a href="#" class="ink-button all-40 double-bottom-space" id="all">Select
					all</a>
			</div>
			...
			<div class="all-50">
				<div class="column-group">
					<div class="all-50 align-left">
						<a href="new_faultload_2.jsp" class="ink-button all-95">&lt;
							Previous</a>
					</div>
					<div class="all-50 align-right">
						<button class="ink-button all-95" type="submit" id="nextfl"
