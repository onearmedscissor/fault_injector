...
<body>
	<div class="ink-grid">
		...
		<header class="vertical-space">
			<h1>
				FAULT INJECTOR<small>Workload details</small>
			</h1>
				...
				<table class="ink-table alternating hover">
					<tbody>
						...
						<tr>
							...
							<td class="all-75 fw-300"><s:property
									value="workload.app_1_name" /></td>
						</tr>
						<s:if
							test="workload.app_2_name!=null && workload.app_2_name.length() > 0">
							<tr>
								<td class="all-25 align-right fw-400">Application #2</td>
								<td class="all-75 fw-300"><s:property
										value="workload.app_2_name" /></td>
							</tr>
						</s:if>
						<s:if
							test="workload.app_3_name!=null && workload.app_3_name.length() > 0">
							<tr>
								<td class="all-25 align-right fw-400">Application #3</td>
								<td class="all-75 fw-300"><s:property
										value="workload.app_3_name" /></td>
							</tr>
						</s:if>
					</tbody>
				</table>
