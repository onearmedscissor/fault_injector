				...
				<table class="ink-table alternating hover">
					<tbody>
						...
						<tr>
							...
							<td class="all-75 fw-300"><s:property
									value="experiment.description" /></td>
						</tr>
					</tbody>
				</table>
			</div>
