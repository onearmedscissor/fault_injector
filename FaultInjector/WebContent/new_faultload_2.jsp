...
<body>
	<div class="ink-grid">
		...
		<div class="column-group">
			<div class="all-100">
				<form action="createfaultload21" id="page_2" class="ink-form all-100 small-100 tiny-100" method="post">
					<fieldset>
						...
						<div class="control-group column-group gutters required">
							...
							<div class="control all-10">
								<s:textfield id="numberfaults" name="numberFaults" value="%{#session.faultloadBean.numberFaults}" />
							</div>
						...
						<div class="column-group gutters">
							<div class="control-group all-30 required">
								<div class="column-group gutters">
									...
									<div class="control all-33">
										<s:textfield id="bitstart" name="bitStart" value="%{#session.faultloadBean.bitsChangeStart}" />
									</div>
								</div>
							</div>
							<div class="control-group all-15">
								<div class="column-group">
									...
									<div class="control all-60">
										<s:textfield id="bitend" name="bitEnd" value="%{#session.faultloadBean.bitsChangeEnd}" />
									</div>
								</div>
							</div>
							<div class="all-55"></div>
