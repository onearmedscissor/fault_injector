...
<title>Fault Injector: Create new faultload [2/4]</title>
...
<body>
	<div class="ink-grid">
				...
				<div class="all-85">
					<nav class="ink-navigation">
						<ul class="breadcrumbs green">
							...
							<li class="active"><a href="#">New faultload [2/4]</a></li>
						</ul>
					</nav>
				</div>
				<div class="all-15">
		...
		<div class="column-group">
			...
			<div class="all-80">
				<h2 class="bottom-space">Create new faultload [2/4]</h2>
			</div>
		</div>

		<div class="column-group">
			<div class="all-100">
				<form action="createfaultload21" id="page_2"
					class="ink-form all-100 small-100 tiny-100" method="post">
					<fieldset>
						<div class="control-group column-group gutters required">
							<p class="label all-20 align-right push-middle">Hardware
								fault type</p>
							<ul id="hwfaulttype" class="control unstyled all-80 inline">
								<s:if test="%{#session.faultloadBean.hardwareFaultType == 'r'}">
									<li><input type="radio" id="reg" name="hardwareFaultType"
										value="r" checked><label for="reg">register</label></li>
									<li><input type="radio" id="mem" name="hardwareFaultType"
										value="m"><label for="mem">memory</label></li>
								</s:if>
								<s:else>
									<li><input type="radio" id="reg" name="hardwareFaultType"
										value="r"><label for="reg">register</label></li>
									<li><input type="radio" id="mem" name="hardwareFaultType"
										value="m" checked><label for="mem">memory</label></li>
								</s:else>
							</ul>
						</div>
						...
						<div class="column-group gutters">
							<div class="control-group all-30 required">
								<div class="column-group gutters">
									<label for="memstart" class="all-66 align-right">Memory
										fault range</label>
									<div class="control all-33">
										<s:textfield id="memstart" name="memStart"
											value="%{#session.faultloadBean.memoryFaultRangeStart}"
											disabled="true" />
									</div>
								</div>
							</div>
							<div class="control-group all-15">
								<div class="column-group">
									...
									<div class="control all-60">
										<s:textfield id="memend" name="memEnd"
											value="%{#session.faultloadBean.memoryFaultRangeEnd}"
											disabled="true" />
									</div>
								</div>
							</div>
						...
						<div class="control-group column-group gutters required">
							<label for="name" class="all-20 align-right">Number of
								faults</label>
							<div class="control all-10">
								<s:textfield id="numberfaults" name="numberFaults"
									value="%{#session.faultloadBean.numberFaults}" />
							</div>
					...
					<fieldset>
						<div class="control-group column-group gutters required">
							...
							<ul class="control unstyled all-80 inline">
								<s:if test="%{#session.faultloadBean.bitFlip}">
									<li><input type="radio" id="bitflip" name="faultClass"
										value="true" checked><label for="bitflip">bit-flip</label></li>
									<li><input type="radio" id="stuckat" name="faultClass"
										value="false"><label for="stuckat">stuck at</label></li>
								</s:if>
								<s:else>
									<li><input type="radio" id="bitflip" name="faultClass"
										value="true"><label for="bitflip">bit-flip</label></li>
									<li><input type="radio" id="stuckat" name="faultClass"
										value="false" checked><label for="stuckat">stuck
											at</label></li>
								</s:else>
							</ul>
						</div>
						...
						<div class="column-group gutters">
							<div class="control-group all-30 required">
								<div class="column-group gutters">
									<label for="bitstart" class="all-66 align-right">Bit(s)
										to change</label>
									<div class="control all-33">
										<s:textfield id="bitstart" name="bitStart"
											value="%{#session.faultloadBean.bitsChangeStart}" />
									</div>
								</div>
							</div>
							<div class="control-group all-15">
								<div class="column-group">
									...
									<div class="control all-60">
										<s:textfield id="bitend" name="bitEnd"
											value="%{#session.faultloadBean.bitsChangeEnd}" />
									</div>
								</div>
							</div>
							<div class="all-55"></div>
							...
							<div class="all-50">
								<div class="column-group">
									<div class="all-50 align-left">
										<a href="createfaultload1" class="ink-button all-95">&lt;
											Previous</a>
									</div>
